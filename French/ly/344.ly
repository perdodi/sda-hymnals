% Lily was here -- automatically converted by c:/Program Files (x86)/LilyPond/usr/bin/midi2ly.py from output/344.mid
\version "2.14.0"
...
trackDchannelB = \relative c {
  ...
  g128*115 r128*13 
  | % 21
  c128*43 r128*5 c4*43/96 r4*5/96 e4*86/96 r4*10/96 e4*86/96 
  r4*10/96 
  | % 22
  c4*172/96 r4*20/96 c4*172/96 r4*20/96 
  | % 23
...
trackEchannelB = \relative c {
  ...
  r4*10/96 
  | % 22
  c4*172/96 r4*20/96 e,4*86/96 r4*10/96 f4*86/96 r4*10/96 
  | % 23
  g4*86/96 r4*10/96 g4*86/96 r4*10/96 g,128*43 r128*5 c4*43/96 
  r4*5/96 
  | % 24
  c128*115 
}
